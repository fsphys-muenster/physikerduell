 ...
 * to let the user pick a file and returns the choosen file name.
 * 
...
public class FileChooser {
	...
	/**
	 * Method to let the user pick a file and return the full file name as a string. If
	 * the user didn't pick a file then the file name will be null.
	 * 
